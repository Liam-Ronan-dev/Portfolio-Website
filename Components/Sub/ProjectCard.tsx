      ...
      <div className="sm:order-1 sm:text-left text-center p-6">
        ...
        <div className="flex flex-col sm:flex-row gap-8">
          {link && (
                  <a
                  href={link}
                  className="text-slate-300 w-1/4 p-8 py-4 flex justify-center hover:scale-105 items-center transition duration-300 ease-in-out rounded-lg border border-1 border-[#ffffff] cursor-pointer hover:bg-[#111111] uppercase tracking-wider"
                  target="_blank" 
